  ...
  return (
    <div className="space-y-5 max-w-lg">
      <div className="border p-4 space-y-3">
        ...
        <button onClick={gen} className="px-5 h-10 bg-zinc-900 text-white text-sm">Generate</button>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="border p-4 text-center">
          ...
          <button onClick={roll} className="px-5 h-10 bg-zinc-900 text-white text-sm mt-3">Roll</button>
        </div>
        <div className="border p-4 text-center">
          ...
          <button onClick={flip} className="px-5 h-10 bg-zinc-900 text-white text-sm mt-3">Flip</button>
        </div>
      </div>
    </div>
  )

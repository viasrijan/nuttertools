  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <div className="flex gap-2 mt-2"><Button variant="secondary" size="sm" onClick={encode}>Encode</Button><Button variant="outline" size="sm" onClick={decode}>Decode</Button></div>
      ...
      <div className="border-t pt-4">
        ...
        }} className="border border-dashed border-zinc-300 dark:border-zinc-700 h-12 mt-2  outline-none focus:border-indigo-600" />

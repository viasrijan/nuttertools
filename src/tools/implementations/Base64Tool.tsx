  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <div className="flex gap-2 mt-2"><button onClick={encode} className="px-3 h-8 bg-white text-zinc-900 ring-1 ring-zinc-300 dark:ring-zinc-600 text-xs">Encode</button><button onClick={decode} className="px-3 h-8 border text-xs">Decode</button></div>

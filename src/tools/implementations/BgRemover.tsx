  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        {orig && <div><p className="text-xs mb-1">Original</p><img src={orig} className="border rounded-xl"/></div>}
        {out && <div><p className="text-xs mb-1">No Background</p><div className="bg-[url('https://i.imgur.com/8Km9tLL.png')]"><img src={out} className="border rounded-xl"/></div><a href={out} download="no-bg.png" className="text-xs underline mt-2 block">Download PNG</a></div>}
      </div>
    </div>
  )
}

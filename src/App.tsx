  ...
  return (
    <div className="min-h-screen flex flex-col">
      <div aria-hidden className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
        <div className="absolute -top-1/4 -left-[10%] w-[65vw] h-[65vw] rounded-full bg-sky-300/40 dark:bg-sky-500/15 blur-[120px] animate-[omni-drift-a_26s_ease-in-out_infinite]" />
        <div className="absolute top-1/3 -right-[15%] w-[55vw] h-[55vw] rounded-full bg-pink-300/40 dark:bg-fuchsia-500/15 blur-[120px] animate-[omni-drift-b_32s_ease-in-out_infinite]" />
        <div className="absolute -bottom-1/4 left-1/4 w-[60vw] h-[60vw] rounded-full bg-indigo-300/35 dark:bg-indigo-500/15 blur-[130px] animate-[omni-drift-c_38s_ease-in-out_infinite]" />
        <div className="absolute top-[15%] left-1/3 w-[40vw] h-[40vw] rounded-full bg-amber-200/30 dark:bg-amber-500/10 blur-[110px] animate-[omni-drift-b_44s_ease-in-out_infinite]" />
      </div>
          ...
          <div className="flex flex-col-reverse md:flex-row items-start justify-between gap-10">
            ...
            <div className="md:text-right flex flex-col items-start md:items-end gap-3">
              <a href="https://www.paypal.me/iSrijan" target="_blank" rel="noreferrer"
                className="inline-flex items-center gap-1.5 px-3 h-[20px] text-[11px] font-bold bg-gradient-to-r from-red-600 to-pink-600 text-white hover:opacity-90 hover:scale-105 transition-all">
                Donate

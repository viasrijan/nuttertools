  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <footer className="bg-gradient-to-b from-transparent to-neutral-400/60 dark:from-transparent dark:to-zinc-900">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 pt-12 md:pt-16 pb-5 sm:pb-8">
          <div className="flex flex-col-reverse md:flex-row items-center md:items-start justify-between gap-10">
            ...
            <div className="md:text-right flex flex-col items-center md:items-end gap-4">
              ...
              <div>
                <p className="text-[33px] font-extrabold tracking-[-0.03em] leading-none bg-gradient-to-br from-emerald-500 to-emerald-800 bg-clip-text text-transparent">NutterTools</p>

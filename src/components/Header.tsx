        ...
        <div className="rounded-full border border-zinc-200/90 bg-white soft-shadow">
          <div className="px-3 sm:px-6 h-[64px] sm:h-[68px] flex items-center gap-3">
            ...
            <Link to="/" onClick={() => setMOpen(false)}
              ...
              <Logo size={32} />
              <span className="text-[25px] font-extrabold tracking-[-0.03em] bg-gradient-to-br from-emerald-500 to-emerald-800 bg-clip-text text-transparent">
                NutterTools
              </span>
            </Link>
            ...
            <button onClick={toggle} aria-label="Toggle theme" aria-pressed={dark}
              className="w-9 h-9 shrink-0 rounded-full bg-yellow-400 text-white dark:text-black grid place-items-center hover:scale-105 active:scale-90 transition-transform duration-300">
        ...
        <div className="lg:hidden fixed inset-0 z-[60] bg-[#f2f2f2] dark:bg-[#262626] overflow-y-auto animate-[omni-drop_0.2s_ease-out]">
          <div className="px-4 sm:px-6 pt-5 flex items-center justify-between gap-3">
            <span className="flex items-center gap-3">
              <Logo size={34} />
              <span className="text-[26px] font-extrabold tracking-[-0.03em] bg-gradient-to-br from-emerald-500 to-emerald-800 bg-clip-text text-transparent">NutterTools</span>
            </span>

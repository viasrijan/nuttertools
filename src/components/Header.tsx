  ...
  return (
    <header ref={headerRef} className="sticky top-0 z-50 pt-0 sm:pt-8 px-0 sm:px-3.5">
      <div className="mx-auto max-w-[1200px] relative">
        <div className=" sm: border border-transparent bg-[#ececec] lg:bg-white soft-shadow max-lg:dark:bg-[#1a1a1a]">
          <div className="px-4 sm:px-6 pt-3 sm:pt-4 lg:pt-0 lg:h-[68px] lg:flex lg:items-center lg:gap-3">
            ...
            <div className="lg:hidden relative mt-2.5 pb-2.5">
              <div className="flex items-center h-9 border border-zinc-200 bg-white  overflow-hidden shadow-[inset_0_2px_4px_rgba(0,0,0,0.06)] max-lg:dark:bg-[#242424] max-lg:dark:border-zinc-800">
            ...
            <div ref={searchRef} className="relative shrink-0 hidden lg:block w-[150px] sm:w-[210px] md:w-[250px] xl:w-[300px]">
              <div className="flex items-center h-9 sm:h-10 border border-zinc-200 bg-zinc-100  overflow-hidden shadow-[inset_0_2px_4px_rgba(0,0,0,0.06)]">

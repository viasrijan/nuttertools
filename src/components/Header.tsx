                ...
                <div key={g.id} className="relative"
                  ...
                  {open === g.id && (
                    <div className="absolute left-0 top-full pt-2">
                      <div className="w-[340px] origin-top rounded-3xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 soft-shadow p-2 animate-[omni-drop_0.15s_ease-out]">
        ...
        <div className="lg:hidden fixed inset-0 z-[60] bg-[#f2f2f2] dark:bg-[#1b1b1b] overflow-y-auto animate-[omni-drop_0.2s_ease-out]">
          <div className="px-4 sm:px-6 pt-5 flex items-center justify-between gap-3">
            <span className="flex items-center gap-2.5">
              <Logo size={26} />
              <span className="text-[20px] font-extrabold tracking-[-0.03em] text-green-600 dark:text-green-400">NutterTools</span>
            </span>

import {
  ...
  Files, Film, Fingerprint, FolderArchive, Frame, Gauge, Ghost, GitBranch, Globe, GraduationCap,
  Hash, Highlighter, History, Home, IdCard, Image as ImageIcon, ImagePlus, Images, Keyboard, KeyRound,
  KeySquare, Landmark, Languages, Layers, Link, Link2, ListChecks, ListOrdered, ListTree, Lock, LockKeyhole,
  Mail, MailCheck, Maximize2, MessagesSquare, Mic, Mic2, Minimize2, Monitor, Moon, Music,
  Music2, Network, NotebookPen, NotepadText, PaintBucket, Palette, Pen, PenLine, Pencil, Percent,
  Pipette, QrCode, Radar, Radio, RadioTower, Rainbow, Receipt, Regex, Repeat, Repeat2, Rewind,
  Rotate3d, RotateCcw, RotateCw, Ruler, ScanQrCode, ScanText, Scissors, ScrollText, Search, Server,
  Shapes, Share2, Sheet, Shield, ShieldAlert, ShieldCheck, ShieldX, Sigma, Slice, SlidersHorizontal,
  ...
  Video, VolumeX, Wand2, WandSparkles, Waypoints, Waves, Weight, Wind, Workflow, Wrench, Zap, ZoomIn,
} from 'lucide-react'

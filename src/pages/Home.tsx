      ...
      <section className="pb-12 md:pb-16">
        <p className={`${SECTION_LABEL} mb-5 md:mb-6 text-center`}>Browse by Categories</p>
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
              {CATEGORIES.map((c) => (
                <Link key={c.slug} to={`/tools/${c.slug}`}
                  className={`group relative overflow-hidden rounded-2xl p-5 ${tileGrad(c.hue)} soft-shadow transition-all duration-300 ease-out hover:-translate-y-1 hover:scale-[1.02] hover:shadow-[0_16px_40px_-12px_rgba(0,0,0,0.35)] flex flex-col items-center text-center`}>
          ...
          <section className="pb-12 md:pb-16">
            ...
            <div className="relative overflow-hidden rounded-3xl bg-white dark:bg-[#242424]/90 border border-zinc-200/70 dark:border-zinc-800 px-6 md:px-12 py-8 md:py-10 flex flex-col justify-center soft-shadow">
            ...
            <section className="pb-12 md:pb-16">
              ...
              <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-red-800 via-rose-800 to-pink-700 px-6 md:px-12 py-10 md:py-12 soft-shadow flex flex-col justify-center transition-transform duration-300 hover:scale-[1.005]">

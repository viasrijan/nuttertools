...
const H: Record<Hue, HueDef> = {
  sky: {
    tile: 'bg-gradient-to-br from-sky-400 to-blue-600 text-white',
  ...
  rose: {
    tile: 'bg-gradient-to-br from-rose-400 to-red-600 text-white',
  ...
  indigo: {
    tile: 'bg-gradient-to-br from-indigo-400 to-violet-600 text-white',
  ...
  emerald: {
    tile: 'bg-gradient-to-br from-emerald-400 to-teal-600 text-white',
  ...
  fuchsia: {
    tile: 'bg-gradient-to-br from-fuchsia-400 to-pink-600 text-white',
  ...
  purple: {
    tile: 'bg-gradient-to-br from-purple-400 to-violet-600 text-white',
  ...
  cyan: {
    tile: 'bg-gradient-to-br from-cyan-400 to-sky-600 text-white',
  ...
  lime: {
    tile: 'bg-gradient-to-br from-lime-400 to-green-600 text-white',
  ...
  orange: {
    tile: 'bg-gradient-to-br from-orange-400 to-amber-600 text-white',
  ...
  violet: {
    tile: 'bg-gradient-to-br from-violet-400 to-purple-600 text-white',

import{r as s,j as t}from"./index-DoLVWPbT.js";function u(){const[o,r]=s.useState("NutterTools"),[l,i]=s.useState("Free, privacy-first internet tools that run entirely in your browser."),[a,c]=s.useState(`Tools
